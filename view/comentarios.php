    ...
    <div class="container mt-5">
            ...
            <div class="toast-container position-fixed top-0 end-0 p-3">
                <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="toast-header">
                        <strong class="me-auto">Gracias!! tomaremos en cuenta tu sugerencia</strong>
        ...
        <form method="POST" class="mb-4">
            <div class="form-floating">
                ...
                <label for="mensaje">Manda tu Sugerencia</label>
            </div>
            <button type="submit" class="btn btn-danger mt-2 w-100">Enviar</button>
        </form>

        <h3>Sugerencias Recientes</h3>
        <?php while ($row = $result->fetch_assoc()) { ?>
            <div class="border p-3 mb-3 rounded">
                <p><strong><?php echo $row['username']; ?></strong> mando:</p>
                <p><?php echo $row['mensaje']; ?></p>
                <p>Se Ingreso en la fecha : <?php echo $row['fecha']; ?></p>
            </div>
        <?php } ?>
    </div>
