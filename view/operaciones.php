...
<body>
    ...
    <form action="<?= $id ? '../data/actualizar.php' : '../php/insertarArticulo.php' ?>" method="POST">
        ...
        <input type="text" name="titulo" id="titulo" value="<?= $id ? $programa['titulo'] : '' ?>" required>
        
        <label for="genero">Género:</label>
        <input type="text" name="genero" id="genero" value="<?= $id ? $programa['genero'] : '' ?>">
        
        <label for="canal">Canal:</label>
        <input type="text" name="canal" id="canal" value="<?= $id ? $programa['canal'] : '' ?>">
        ...
        <textarea name="descripcion" id="descripcion" required><?= $id ? $programa['descripcion'] : '' ?></textarea>
        
        <button type="submit"><?= $id ? 'Actualizar Programa' : 'Agregar Programa' ?></button>
        <form method="POST" action="../view/recibirDatos.php">
