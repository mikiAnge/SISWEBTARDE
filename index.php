...
if (isset($_SESSION['usuario_id'])) {
    // Redirigir a inicio.php si el usuario está autenticado
...
<body>
    <div class="container">
        <!-- Toast para mensaje de usuario creado exitosamente -->
        ...
        <!-- Toast para error de usuario no encontrado -->
        ...
        <!-- Toast para error de contraseña incorrecta -->
        ...
        <!-- Toast para mensaje de sesión cerrada -->
        ...
        <!-- Si el usuario no está autenticado, mostrar los formularios -->
